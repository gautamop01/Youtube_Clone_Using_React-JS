...
// import avatarSrc from "../pics/Myphoto.png";
...
const NavProfile = () => {
  return (
    <div className='flex gap-6 absolute right-5 items-center'>
      ...
      <Menu placement="bottom-end">
          <MenuHandler>
        <Avatar size='sm' src='https://github.com/gautamop01/Youtube_Clone_Using_React-JS/blob/324c6162472d8279d3ac4c6fbd9dc3d131ab15e6/Myphoto.png?raw=true'></Avatar>
        {/* <Avatar size='sm' src='/youtube-clone/src/pics/Myphoto.png'></Avatar> */}
        ...
        <Avatar size='sm' src='https://github.com/gautamop01/Youtube_Clone_Using_React-JS/blob/324c6162472d8279d3ac4c6fbd9dc3d131ab15e6/Myphoto.png?raw=true'></Avatar>
        <h2 className='text-lg text-start leading-6'>
          Gautam Kumar<br/><span className='text-sm'>@gautamop</span>
        </h2>
        </MenuItem>
            </Link>
